...
#definition[
  ...
  #eq[
    $mu_(i in_U {1, ..., m(n)}) ({P(1^n; xi_n^[1, ..., i - 1]) = xi_n^[i]}) <= 1 / 2 + negl(n)$
  ]
]
...
#proof[
  ...
  - $mu({D(1^n; xi_n) = 1}) = mu({P(1^n; xi_n^[1, ..., i-1]) = xi_n^[i]}) > 1 / 2 + 1 / p(n)$
  ...
  которое получается аналогичным расписываниям выше, но для $sigma_(i - 1) (n)$.
